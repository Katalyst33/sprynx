    ...
    <div className="-z-30 text-center">
      <div className="lg:flex gap-20 mx-auto w-5/6 lg:py-24 py-16 lg:items-center lg:justify-center">
        <div className=" lg:text-right lg:w-2/6">
          ...
          <p className="mt-2 text-lg">
            Sprynx Multi is a technology start up that delivers car services directly
            to its customers’ doorstep.
          </p>
        </div>
        <div className="flex justify-center mt-10"><img src={Aboutimg} className="h-72 shadow-lg rounded-3xl"/></div>
      </div>
      ...
      <div className="mt-14 lg:flex md:flex-cols-2 lg:flex-cols-3 w-5/6 mx-auto">
        <div className="mt-6 lg:mt-0 py-10 px-7 rounded-xl lg:w-2/6">
          ...
          <Link to="/all-packages"><button className="pointer transition ease-in-out duration-400 hover:bg-blue-600 bg-blue-900 rounded-md px-5 py-2 text-white shadow-md mt-5">
            Our Packages
          </button></Link>
        </div>
        <div className="mt-6 lg:mt-0 py-10 px-7 rounded-xl lg:w-2/6">
        ...
        <div className="mt-6 lg:mt-0 py-10 px-7 rounded-xl lg:w-2/6">
          ...
          <p className="text-lg">Call us on our lines for the best of services</p>
          <button className="pointer transition ease-in-out duration-400 hover:bg-blue-600 bg-blue-900 rounded-md px-5 py-2 text-white shadow-md mt-5">
            Contact Us
          </button>
        </div>
