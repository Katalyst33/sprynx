  ...
  return (
    <>
      <div className="lg:flex justify-between items-center w-4/6 mx-auto mb-4">
        <h1 className="text-xl font-semibold text-gray-900">All Services Page ({allServiceData.length})</h1>
        <div className="">
          <Link to="/manager/create-service" className="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:w-auto">
            Create Service
          </Link>
        </div>
      </div>
