    ...
    return (
      <div className="text-center">
        <div className="lg:flex gap-20 mx-auto w-5/6 lg:py-24 py-16 lg:items-center lg:justify-center">
          ...
          <div className="flex justify-center mt-10"><img src={ContactImg} className="h-72 shadow-lg rounded-3xl"/></div>
        </div>
        ...
        <div className="mb-16 lg:flex lg:gap-4 w-5/6 mx-auto">
          <div className="lg:w-4/6 py-10">
            ...
            <p className="text-lg"><span className="font-bold">Island: </span>Ikoyi, Victoria Island, Lekki, Ajah, Ado/Badore, Sangotedo, Abijo, Awoyaya, Lakowe, Eputu  & environs.</p>
            <p className="mt-2 text-lg"><span className="font-bold">Mainland: </span>Surulere, Fadeyi, Yaba, (T & C Applies).</p>
        ...
        <div className="my-20">
          <h3 className="text-2xl text-blue-900 font-semibold">Frequently Asked Question</h3>
          <div className="w-5/6 mx-auto lg:flex lg:gap-10 rounded-xl bg-gradient-to-r from-blue-100 to-green-100 px-10 py-6 mt-10">
            <div className="mt-7 lg:w-[30%] text-lg">
              <h4 className="font-bold text-lg text-blue-400">How does booking work?</h4>
            ...
            <div className="mt-7 lg:w-[30%]">
              <h4 className="font-bold text-lg text-blue-400">Do i need to have any equipment?</h4>
              <p>The detailers, on the Sprynx Multi-platform, arrive at your location fully-equipped with all the supplies they need to ensure that your car is spotless.</p>
            </div>
            <div className="mt-7 lg:w-[30%]">
              <h4 className="font-bold text-lg text-blue-400">Water based wash?</h4>
              <p>If you prefer a water-based wash, we do ask that you specify that prior to the wash by selecting the correct add-on during the booking flow. We also ask the customer to provide the water supply and we will send out a tech equipped with a power wash hookup and hose.</p>
            </div>
          </div>
        </div>
      </div>
