...
const OurServicesPage = () => {
  return (
    <div>
        <div className='text-4xl font-bold tracking-tight text-blue-900 sm:text-4xl lg:text-5xl my-52'>Our Services</div>
        <div>
            <p className='bg-blue-50 px-20 py-16'>Here at Sprynx Multi, we get to asked a lot of questions. There is one question that keeps popping up, however: “What is the difference between car detailing and car washing?”
...
Simply put, getting your car detailed means a top-to-bottom thorough cleaning of your vehicle using specialized tools and products. Normally, a detailer will also perform some light cosmetic touch-ups, but the process does not include paintwork or body repairs</p>
        </div>
        ...
        <div className='lg:flex gap-5 w-5/6 mx-auto my-20'>
            <div className='w-[370px] mx-auto mb-12 p-4'>
                ...
                <h3 className='font-bold text-lg text-blue-400 mb-2 mt-4'>Car Waxing</h3>
                <p>Car wax smoothes the paint surface and will reduce the friction between debris and your car, meaning that tiny debris is more likely to slide off your car rather than damage it.</p>
            </div>
            <div className='w-[370px] mx-auto mb-12 p-4'>
            <p className='flex justify-center mb-3 text-2xl text-blue-400'><FaBullseye /></p>
                <h3 className='font-bold text-lg text-blue-400 mb-2 mt-4'>Car Polishing</h3>
                <p>Car polish is a product that helps to eliminate surface scratches, swirls, oxidation, dirt, and other minor imperfections. Polish should be used before wax, as it helps to restore auto paint that has lost its shine due to oxidation.</p>
            </div>
            <div className='w-[370px] mx-auto mb-12 p-4'>
            <p className='flex justify-center mb-3 text-2xl text-blue-400'><FaBullseye /></p>
                <h3 className='font-bold text-lg text-blue-400 mb-2 mt-4'>Headlight Restoration</h3>
                <p>Headlight restoration or plastic headlight restoration is the act of refinishing aged headlight lenses that have become discolored or dull due to oxidation primarily due to UV light and other environmental factors such as road debris impact rain, and exposure to caustic chemicals</p>
            </div>
            <div className='w-[370px] mx-auto mb-12 p-4'>
            <p className='flex justify-center mb-3 text-2xl text-blue-400'><FaBullseye /></p>
                <h3 className='font-bold text-lg text-blue-400 mb-2 mt-4'>Engine Cleaning</h3>
                <p>A clean engine makes a used car look newer and better maintained. Some shops that perform engine cleaning services claim a clean engine even runs a little cooler because removing the gunk formed by dirt, oil and grease allows engines to run cooler</p>
            </div>
        </div>
