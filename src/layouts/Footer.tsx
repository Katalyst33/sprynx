  ...
  return (
    <section className="bg-blue-400 mt-14">
      <div className='text-center text-white pt-20 pb-8 flex flex-col flex-wrap w-5/6 mx-auto'>
        ...
        <h4 className='mt-5 md:mt-2 lg:mt-1'>Mon, Tues & Wed: 8am - 7pm Thurs: 8am - 4pm Fri: 8am - 7pm Sat: 9am - 7pm Sun: Off</h4>
        <img alt='LOGO' className='text-3xl mt-8'/>
        ...
        <div className="flex justify-center text-gray-600 gap-10 my-10 flex-col lg:flex-row lg:gap-y-0">
          ...
          <a className='hover:text-blue-900 cursor-pointer'>Terms and Conditions</a>
        </div>
      </div>
    </section>
  )
